...
import { faInfo, faSort, faSortUp, faSortDown,faArrowRight } from '@fortawesome/free-solid-svg-icons';
...
const AfficherMissionDA = () => {
   const navigate = useNavigate();
    ...
    const handleNavigateToNewRoute = (missionId) => {
      navigate(`/afficherFacturationDA/${missionId}`);
  };
...
export default AfficherMissionDA;
