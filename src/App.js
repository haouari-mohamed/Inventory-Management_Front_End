...
const routes = [
  ...
  { path: '/afficherFacturationDA/:idMissionf', element: FacturationManager, title: 'Afficher facturation DAF - CID',public:true },
  { path: '/afficherFacturationRE', element: FacturationManagerRE, title: 'Afficher facturation RECOUVREMENT - CID',public:true },
  { path: '/afficherEncaisementRE/:idFacturef', element: EncaissementManager, title: 'Afficher encaisement RECOUVREMENT - CID',public:true },
